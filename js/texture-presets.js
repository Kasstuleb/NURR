...
(function(){
  window.NURR_TEXTURE_PRESETS = [
    ...
    { id:'chromatic-haze', name:'Chromatic haze', mode:0, amount:0.72, scale:0.45, softness:0.86, distortion:0.0, access:'experimental' },
    { id:'print-noise', name:'Pixelate', mode:5, amount:0.50, scale:0.62, softness:0.88, distortion:0.0, access:'experimental' }
  ];
})();
